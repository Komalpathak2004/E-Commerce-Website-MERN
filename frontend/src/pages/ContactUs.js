...
const ContactUs = () => {
  ...
  const contactInfo = [
    ...
    {
      icon: <span role="img" aria-label="office">☎️</span>,
      title: "Office",
      content: "011-45539682"
    },
    {
      icon: <span role="img" aria-label="mobile">📱</span>,
      title: "Mobile",
      content: "8800323699, 9899945401, 9910568127"
    },
    {
      icon: <span role="img" aria-label="helpline">📞</span>,
      title: "Helpline",
      content: "8130030600"
    },
    {
            ...
            <div className="space-y-6">
              {contactInfo.map((item, index) => (
                <div key={index} className="flex items-start space-x-4 p-4 bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow duration-200">
                  <div className="flex-shrink-0 w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center text-blue-600 text-xl">
                    {item.icon}
                  </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border overflow-hidden">
            <div className="h-80 bg-gray-100 flex items-center justify-center">
              <div className="text-center">
                <span role="img" aria-label="location" className="text-4xl mb-4">📍</span>
